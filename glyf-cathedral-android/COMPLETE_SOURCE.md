# GLYF Cathedral Android — Complete Source Code
...
3. [UI Layer](#ui-layer)
4. [Cron System](#cron-system)
5. [Rosetta Bridge](#rosetta-bridge)
...
### `data/LatticeRepository.kt` (214 lines)
...
### `ui/visualization/HexLatticeView.kt` (329 lines)
...
### `ui/LatticeScreens.kt` (233 lines)
...
### `ui/LatticeViewModel.kt` (180 lines)
...
### `cron/LatticeWorkers.kt` (246 lines)
...
### `cron/CronInfrastructure.kt` (50 lines)
...
### `rosetta/RosettaTelegramBridge.kt` (234 lines)
...
### `CathedralApplication.kt` (16 lines)
...
android {
    namespace = "com.glyf.cathedral"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.glyf.cathedral"
        minSdk = 26
        targetSdk = 34
        versionCode = 702
        versionName = "0.7.2-phi7"
...
| File | Lines | Purpose |
|------|-------|---------|
| `Models.kt` | 349 | Core φ⁷ data structures |
| `Entities.kt` | 192 | Room database entities |
| `LatticeRepository.kt` | 214 | Data access layer |
| `HexLatticeView.kt` | 329 | Canvas visualization |
| `LatticeScreens.kt` | 233 | Compose UI screens |
| `LatticeViewModel.kt` | 180 | State management |
| `LatticeWorkers.kt` | 246 | Cron workers |
| `CronInfrastructure.kt` | 50 | Boot receiver |
| `RosettaTelegramBridge.kt` | 234 | Telegram protocol |
| `MainActivity.kt` | 123 | Entry point |
| `CathedralApplication.kt` | 16 | Application class |
| `app/build.gradle.kts` | 95 | Build config |
| **Total** | **2,281** | **Complete source** |

---

*GLYF Cathedral Android v0.7.2 φ⁷ — Generated 2026-03-23*
